...
$experience = [
	[
    	'profession' => 'Танцор диско',
        'start_date' => 'Ноя 2022',
        'finish_date' => 'Current',
        'description' => 'Два прихлопа, три притопа - вот и вся работа.',
	],
    [
    	'profession' => 'Тестировщик матрасов',
        'start_date' => 'Июн 2022',
        'finish_date' => 'Окт 2022',
        'description' => 'Лежал, спал, смотрел сны.',
    ],
    [
    	'profession' => 'Актер массовки',
        'start_date' => 'Май 2022',
        'finish_date' => 'Июн 2022',
        'description' => 'Стоял в толпе. Ходил в толпе. Улыбался с толпой.',
    ],
];
?>
<!DOCTYPE html>
          ...
          <h2 class="w3-text-grey w3-padding-16"><i
              ...
              <?php for($i = 0; $i < count($experience); $i++) :?>
                <div class="w3-container">
                  ...
                  <?php if ($experience[$i][finish_date] == 'Current') {?>
                    <span class="w3-tag w3-teal w3-round">Current</span><?php }
                    else {?>
                    <?php echo $experience[$i][finish_date]; ?>
                    <?php } ?>
                  </h6>
